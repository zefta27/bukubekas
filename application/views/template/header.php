...
<head>
    ...
    <title>HALAMAN ADMIN TOKO BUKU UGRAH</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=<?php echo base_url() ?>rumah><b><img src=<?php echo base_url() ?>asset/images/ugrah.png  style='height:35px' >&nbspHALAMAN ADMIN TOKO BUKU UGRAH</b></a>
